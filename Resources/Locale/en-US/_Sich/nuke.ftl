mriya-nuke-time-minute = {$minutes} хв
mriya-nuke-time-minutes = {$minutes} хв
mriya-nuke-time-second = {$seconds} с
mriya-nuke-time-seconds = {$seconds} с
mriya-nuke-time-ukrainian = {$value} {$unit}
mriya-nuke-time-ukrainian-minute-one = хвилина
mriya-nuke-time-ukrainian-minute-few = хвилини
mriya-nuke-time-ukrainian-minute-many = хвилин
mriya-nuke-time-ukrainian-second-one = секунда
...
mriya-nuke-popup-anchor-before-disk = Закріпіть заряд перед вставленням диска ядерної автентифікації.
mriya-nuke-popup-officer-disk-required = Для вставлення диска ядерної автентифікації потрібна офіцерська авторизація.
mriya-nuke-popup-already-armed = Заряд уже активовано. Детонація через {$remaining}.
mriya-nuke-popup-already-activating = Заряд уже обробляє послідовність активації.
...
mriya-nuke-popup-operational-map-required = Заряд можна активувати лише в планетарній операційній зоні.
...
mriya-nuke-popup-armed-anchor-locked = Активний ядерний протокол блокує кріплення та транспортування заряду.
mriya-nuke-popup-aborted = Протокол детонації скасовано.
mriya-nuke-popup-not-active = Протокол детонації не активний.

command-description-mriyanuke-unlock = Повністю розблоковує тестовий цикл ядерного заряду Мрії: техопцію, таймлок і декодування.
command-description-mriyanuke-unlocktech = Розблоковує лише покупку ядерного заряду Мрії в дереві технологій.
command-description-mriyanuke-decrypt = Завершує лише декодування ядерного заряду Мрії без зміни техопції.
command-description-mriyanuke-detonationtime = Змінює час від запуску до детонації ядерного заряду Мрії у секундах.
command-description-mriyanuke-decryptiontime = Змінює тривалість декодування ядерного заряду Мрії у секундах.
command-description-mriyanuke-timelock = Змінює таймлок купівлі ядерного заряду Мрії в дереві технологій у секундах.

mriya-nuke-command-unlocked = Ядерний заряд Мрії повністю розблоковано для поточного раунду: техопція, таймлок і декодування.
mriya-nuke-command-tech-unlocked = Техопцію ядерного заряду Мрії розблоковано для поточного раунду. Стан декодування не змінено.
mriya-nuke-command-decrypted = Декодування ядерного заряду Мрії завершено для поточного раунду. Стан техопції не змінено.
mriya-nuke-command-option-not-found = Техопцію ядерного заряду Мрії не знайдено.
mriya-nuke-command-detonation-time-set = Час детонації ядерного заряду Мрії встановлено на {$seconds} с. Оновлено зарядів: {$count}.
mriya-nuke-command-decryption-time-set = Час декодування ядерного заряду Мрії встановлено на {$seconds} с.
mriya-nuke-command-timelock-set = Таймлок купівлі ядерного заряду Мрії встановлено на {$seconds} с.
