...
mriya-nuke-xeno-decryption-paused = Зв'язок із вухо-вежами порушено. Формування Винищувача-вуликів зупинено на {$percent}%. Поверніть вежі Вулику.
mriya-nuke-xeno-decryption-resumed = Ворог утримує дві вухо-вежі. Формування Винищувача-вуликів відновлено, завершення через {$remaining}.
mriya-nuke-xeno-decryption-waiting-towers = Формування Винищувача-вуликів очікує вухо-веж: {$active}/{$required} під контролем ворога.
...
mriya-nuke-examine-disk-inserted = [color=cyan]Заряд декодовано й закріплено, диск ядерної автентифікації вставлено.[/color]
mriya-nuke-examine-ready = [color=cyan]Заряд декодовано й готовий до запуску. Закріпіть його, вставте диск ядерної автентифікації, а потім використайте в руці, щоб розпочати послідовність активації.[/color]
...
mriya-nuke-popup-armed-anchor-locked = Активований заряд блокує свої кріплення.
